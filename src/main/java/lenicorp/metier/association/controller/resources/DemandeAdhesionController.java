...
public class DemandeAdhesionController {
    ...
    public ReadDemandeAdhesionDTO prendreEnEtude(@PathVariable("id") Long demandeId) {
        return service.prendreEnEtude(demandeId);
    }

    // Approuver: vers APPROUVEE ou EN_ATTENTE_PAIEMENT selon droit d'adhésion
    @PutMapping("/{id}/approuver")
    public ReadDemandeAdhesionDTO approuver(@PathVariable("id") Long demandeId) {
    ...
    public ReadDemandeAdhesionDTO confirmerPaiement(@PathVariable("id") Long demandeId) {
        return service.confirmerPaiement(demandeId);
    }

    // Rejeter une demande (motif obligatoire)
    @PutMapping("/{id}/rejeter")
    public ReadDemandeAdhesionDTO rejeter(@PathVariable("id") Long demandeId,
    ...
    public ReadDemandeAdhesionDTO annuler(@PathVariable("id") Long demandeId) {
        return service.annuler(demandeId);
    }

    // Recherche paginée triée du plus ancien au plus récent
    @GetMapping
    public Page<ReadDemandeAdhesionDTO> search(
