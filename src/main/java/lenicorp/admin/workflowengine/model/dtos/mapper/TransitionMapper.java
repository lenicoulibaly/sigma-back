...
public interface TransitionMapper
{
    ...
    @Mappings({
            ...
            @Mapping(target = "transitionExecComponentCode", source = "transitionExecComponent.code"),
            @Mapping(target = "transitionExecComponentName", source = "transitionExecComponent.name"),
    ...
    @Mappings({
            ...
            @Mapping(target = "transitionExecComponent", source = "transitionExecComponentCode"),
